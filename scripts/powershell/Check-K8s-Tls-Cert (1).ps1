...
.THRESHOLD POLICY
    The TLS expiry threshold is a STATIC CONSTANT defined by the
    $ExpiryThresholdDays parameter's default value (30 days).
    ...
    $ExpiryThresholdDays in this file.
...
.PARAMETER ExpiryThresholdDays
    Static default: 30 days. To change the threshold, edit this default
    value in the script - do NOT re-introduce a pipeline parameter for it.
